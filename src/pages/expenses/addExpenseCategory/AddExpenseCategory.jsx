    ...
    <Layout onBackToMain={onBackToMain}>
      <div className="add-expense-category-page flex flex-col flex-grow">
        ...
        <div className="flex flex-col flex-grow">
          ...
          <form ref={formRef} method="POST" action="https://hypermart-new.onlinesytems.com/expenses/addExpenseCategory" onSubmit={handleSubmit} encType="multipart/form-data">
            <input type="hidden" name="_token" value="CQkwW2FUl8j1RxADncsJfUzooTamDQu0NFHxoec5" autoComplete="off" />
